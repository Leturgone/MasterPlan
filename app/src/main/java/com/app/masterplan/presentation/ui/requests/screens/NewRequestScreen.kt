...
fun NewRequestScreen(
    ...
    viewModel: NewRequestsScreenViewModel = hiltViewModel()
){
    ...
    Box(){
        ...
        Column(
            ...
            BigTextFieldWithButton(
                fieldTitle = stringResource(id = R.string.new_request),
                buttonTitle = stringResource(id = R.string.create_request),
            ) {
                viewModel.createNewRequest(it)
            }
